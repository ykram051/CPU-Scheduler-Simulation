...
class RoundRobinScheduler(Scheduler):
    ...
    def schedule(self):
        ...
        while remaining_processes or ready_queue:
            ...
            # If no process is in the ready queue and there are still processes to arrive
            ...
            # If the ready queue is empty, we're done
            if not ready_queue:
                break
        ...
        return {
            **metrics.calculate_rr_metrics(self.completed_processes, self.execution_sequence, self.time_quantum),
